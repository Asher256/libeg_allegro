...
RHIDE_TYPED_LIBS_DJGPP.cxx=
RHIDE_TYPED_LIBS_DJGPP.cpp=
...
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=camera.o carte.o ia.o iaengine.o pos.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
...
MAIN_TARGET=ia.exe
PROJECT_ITEMS=camera.cpp carte.cpp ia.cpp iaengine.cpp pos.cpp
%.o: %.c
	$(RHIDE_COMPILE.c.o)
%.o: %.i
	$(RHIDE_COMPILE_C)
...
all:: ia.exe
DEPS_0=\
		d:/fmsong/eg/ia/camera.o\
		d:/fmsong/eg/ia/carte.o\
		d:/fmsong/eg/ia/ia.o\
		d:/fmsong/eg/ia/iaengine.o\
		d:/fmsong/eg/ia/pos.o
NO_LINK=
